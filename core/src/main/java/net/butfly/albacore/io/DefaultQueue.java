...
class DefaultQueue<IN, OUT> extends AbstractQueue<IN, OUT, Object> implements Queue<IN, OUT, Object> {
	private static final long serialVersionUID = 9187055541366585674L;
	private static final Logger logger = Logger.getLogger(DefaultQueue.class);
	private final LinkedBlockingQueue<Object> impl;

	@SuppressWarnings({ "rawtypes", "unchecked" })
	public DefaultQueue(String name, long capacity, Map<Class, Converter<?, Long>> sizing) {
	...
	public DefaultQueue(String name, long capacity) {
