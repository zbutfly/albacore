...
// Reflections.safeFieldGet(ECKeyFactory.class.getField("instance"), null);
//
// ECPrivateKey priKey = (ECPrivateKey)
...
// BigInteger x1 = new BigInteger("2fe13c0537bbc11acaa07d793de4e6d5e5c94eee8",
// 16);
// BigInteger x2 = new BigInteger("289070fb05d38ff58321f2e800536d538ccdaa3d9",
// 16);
//
...
// BigInteger n = new
// BigInteger("5846006549323611672814741753598448348329118574063", 10);
// // the cofactor
// int h = 2;
// int m = 163;
// int[] ks = { 7, 6, 3 };
...
//
// ECParameterSpec ecParameterSpec = new ECParameterSpec(ellipticCurve, g, n,
// h);
// // 公钥
// ECPublicKey publicKey = Reflections.safeConstruct(
// ECPublicKeyImpl.class.getConstructor(ECPoint.class, ECParameterSpec.class),
// g, ecParameterSpec);
//
// BigInteger s = new
// BigInteger("1234006549323611672814741753598448348329118574063", 10);
// // 私钥
// ECPrivateKey privateKey = Reflections.safeConstruct(
// ECPrivateKeyImpl.class.getConstructor(BigInteger.class,
// ECParameterSpec.class), s, ecParameterSpec);
//
