...
/**
 * Dumps retained and shallow memory taken by an object and its reference hierarchy. This could be improved in a number of ways but works
 * for debugging and "live" object monitoring. For static heap analyses a real performance monitor like YourKit is much better (and
 * accurate?).
 * 
...
public class ObjectTree {
	...
	private static class Node {
		...
		public static Node create(String prefix, Object delegate, IdentityHashMap<Object, Integer> seen) {
			...
			if (seen.containsKey(delegate)) { return new Node("[seen " + uniqueName(delegate, seen) + "]", null); }
