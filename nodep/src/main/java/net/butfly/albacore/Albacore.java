...
public @interface Albacore {
	@interface Props {
		...
		final String PROP_DEBUG_FLAG = "albacore.debug";
		...
		final String PROP_CLASS_SCAN_CACHING = "albacore.classpath.scan.cache.enable";
		...
		final String PROP_PARALLELISM = "albacore.parallelism";// 1 //"albacore.io.stream.parallelism.factor"
