...
public class GDD<V, E> implements Wrapped<Tuple2<List<V>, List<E>>> {
	...
	@Override
	public void foreachRDD(VoidFunction<JavaRDD<Tuple2<List<V>, List<E>>>> consumer) {
	...
	@Override
	public Wrapped<Tuple2<List<V>, List<E>>> persist() {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Wrapped<Tuple2<List<V>, List<E>>> union(Wrapped<Tuple2<List<V>, List<E>>> other) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Wrapped<Tuple2<List<V>, List<E>>> filter(Function<Tuple2<List<V>, List<E>>, Boolean> func) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public <K2, V2> Wrapped<Tuple2<K2, V2>> mapToPair(PairFunction<Tuple2<List<V>, List<E>>, K2, V2> func) {
		// TODO Auto-generated method stub
		return null;
	}
