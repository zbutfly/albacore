...
public class FelParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "Additive", "And", "BooleanLiteral",
			"Bracket", "COMMENT", "CharacterLiteral", "Colon", "DecimalLiteral", "Dot", "Equals", "EscapeSequence", "Exponent",
			"FloatTypeSuffix", "FloatingPointLiteral", "HexDigit", "HexLiteral", "Identifier", "IntegerTypeSuffix", "JavaIDDigit",
			"LINE_COMMENT", "Letter", "Multiplicative", "Not", "OctalEscape", "OctalLiteral", "Or", "Ques", "Relational", "StringLiteral",
			"UnicodeEscape", "WS", "'('", "')'", "','", "']'" };
		...
		try {
			...
			// ! ( conditionalExpression )? )*
			{
				...
				if ((LA1_0 == Additive || LA1_0 == BooleanLiteral || LA1_0 == CharacterLiteral || LA1_0 == DecimalLiteral
						...
						|| LA1_0 == OctalLiteral || LA1_0 == StringLiteral || LA1_0 == 35)) {
					alt1 = 1;
				}
				switch (alt1) {
				case 1:
				...
				loop3: do {
					...
					// conditionalExpression )?
					{
						...
						if ((LA2_0 == Additive || LA2_0 == BooleanLiteral || LA2_0 == CharacterLiteral || LA2_0 == DecimalLiteral
								...
								|| LA2_0 == OctalLiteral || LA2_0 == StringLiteral || LA2_0 == 35)) {
							alt2 = 1;
						}
						switch (alt2) {
						case 1:
	...
	public final FelParser.conditionalOrExpression_return conditionalOrExpression() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 5, conditionalOrExpression_StartIndex);
			}
	...
	public final FelParser.conditionalAndExpression_return conditionalAndExpression() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 6, conditionalAndExpression_StartIndex);
			}
	...
	public final FelParser.equalityExpression_return equalityExpression() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 7, equalityExpression_StartIndex);
			}
	...
	public final FelParser.relationalExpression_return relationalExpression() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 8, relationalExpression_StartIndex);
			}
	...
	public final FelParser.additiveExpression_return additiveExpression() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 9, additiveExpression_StartIndex);
			}
	...
	public final FelParser.multiplicativeExpression_return multiplicativeExpression() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 10, multiplicativeExpression_StartIndex);
			}
	...
	public final FelParser.unaryExpression_return unaryExpression() throws RecognitionException {
		...
		try {
			...
			if ((LA11_0 == Additive)) {
				alt11 = 1;
			} else if ((LA11_0 == BooleanLiteral || LA11_0 == CharacterLiteral || LA11_0 == DecimalLiteral || LA11_0 == FloatingPointLiteral
					|| (LA11_0 >= HexLiteral && LA11_0 <= Identifier) || LA11_0 == Not || LA11_0 == OctalLiteral || LA11_0 == StringLiteral
					|| LA11_0 == 35)) {
				alt11 = 2;
			} else {
				if (state.backtracking > 0) {
	...
	public final FelParser.unaryExpressionNotPlusMinus_return unaryExpressionNotPlusMinus() throws RecognitionException {
		...
		try {
			...
			if ((LA13_0 == Not)) {
				alt13 = 1;
			} else if ((LA13_0 == BooleanLiteral || LA13_0 == CharacterLiteral || LA13_0 == DecimalLiteral || LA13_0 == FloatingPointLiteral
					|| (LA13_0 >= HexLiteral && LA13_0 <= Identifier) || LA13_0 == OctalLiteral || LA13_0 == StringLiteral
					|| LA13_0 == 35)) {
				alt13 = 2;
			} else {
				if (state.backtracking > 0) {
	...
	public final FelParser.array_return array() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 13, array_StartIndex);
			}
	...
	public final FelParser.primary_return primary() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 14, primary_StartIndex);
			}
	...
	public final FelParser.parDot_return parDot() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 15, parDot_StartIndex);
			}
	...
	public final FelParser.identifierOrFun_return identifierOrFun() throws RecognitionException {
		...
		try {
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 16, identifierOrFun_StartIndex);
			}
		...
		try {
			...
			// E:\\workspace\\Fel\\Fel.g:127:9: '(' ! ( expressionList )? ')' !
			{
				...
				if ((LA19_0 == Additive || LA19_0 == BooleanLiteral || LA19_0 == CharacterLiteral || LA19_0 == DecimalLiteral
						...
						|| LA19_0 == OctalLiteral || LA19_0 == StringLiteral || LA19_0 == 35 || LA19_0 == 37)) {
					alt19 = 1;
				} else if ((LA19_0 == 36)) {
