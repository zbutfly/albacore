...
public class FelParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", //
			"Additive", "And", "BooleanLiteral", "Bracket", "COMMENT", "CharacterLiteral", "Colon", //
			"DecimalLiteral", "Dot", "Equals", "EscapeSequence", "Exponent", //
			"FloatTypeSuffix", "FloatingPointLiteral", "HexDigit", "HexLiteral", //
			"Identifier", "IntegerTypeSuffix", "JavaIDDigit", "LINE_COMMENT", "Letter", //
			"Multiplicative", "Not", "OctalEscape", "OctalLiteral", "Or", "Ques", //
			"Relational", "StringLiteral", "UnicodeEscape", "WS", "'('", "')'", "','", "']'" };
	...
	public final FelParser.expressionList_return expressionList() throws RecognitionException {
		...
		try {
			...
			if ((LA1_0 == Additive || LA1_0 == BooleanLiteral || LA1_0 == CharacterLiteral || LA1_0 == DecimalLiteral
					|| LA1_0 == FloatingPointLiteral || (LA1_0 >= HexLiteral && LA1_0 <= Identifier) || LA1_0 == Not
					|| LA1_0 == OctalLiteral || LA1_0 == StringLiteral || LA1_0 == 35)) alt1 = 1;
			switch (alt1) {
			case 1:
				// E:\\workspace\\Fel\\Fel.g:54:9: conditionalExpression
			...
			loop3: do {
				...
				case 1:
					...
					if ((LA2_0 == Additive || LA2_0 == BooleanLiteral || LA2_0 == CharacterLiteral || LA2_0 == DecimalLiteral
							|| LA2_0 == FloatingPointLiteral || (LA2_0 >= HexLiteral && LA2_0 <= Identifier) || LA2_0 == Not
							|| LA2_0 == OctalLiteral || LA2_0 == StringLiteral || LA2_0 == 35)) alt2 = 1;
					switch (alt2) {
					case 1:
						// E:\\workspace\\Fel\\Fel.g:55:10:
						// conditionalExpression
	...
	public final FelParser.conditionalExpression_return conditionalExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					Ques10_tree = (CommonTree) adaptor.create(Ques10);
		...
		try {
			...
			loop5: do {
				...
				case 1:
					...
					if (state.failed) return retval;
					if (state.backtracking == 0) {
						Or15_tree = (CommonTree) adaptor.create(Or15);
		...
		try {
			...
			loop6: do {
				...
				case 1:
					...
					if (state.failed) return retval;
					if (state.backtracking == 0) {
						And18_tree = (CommonTree) adaptor.create(And18);
		...
		try {
			...
			loop8: do {
				...
				case 1:
					...
					if (state.failed) return retval;
					if (state.backtracking == 0) {
						Relational24_tree = (CommonTree) adaptor.create(Relational24);
		...
		try {
			...
			loop9: do {
				...
				case 1:
					...
					if (state.failed) return retval;
					if (state.backtracking == 0) {
						Additive27_tree = (CommonTree) adaptor.create(Additive27);
	...
	public final FelParser.multiplicativeExpression_return multiplicativeExpression() throws RecognitionException {
		...
		try {
			...
			loop10: do {
				...
				if ((LA10_0 == Multiplicative)) alt10 = 1;
				switch (alt10) {
				case 1:
					// E:\\workspace\\Fel\\Fel.g:81:27: Multiplicative ^
					// unaryExpression
					Multiplicative30 = (Token) match(input, Multiplicative, FOLLOW_Multiplicative_in_multiplicativeExpression333);
					if (state.failed) return retval;
					if (state.backtracking == 0) {
						Multiplicative30_tree = (CommonTree) adaptor.create(Multiplicative30);
	...
	public final FelParser.unaryExpression_return unaryExpression() throws RecognitionException {
		...
		try {
			...
			if ((LA11_0 == Additive)) alt11 = 1;
			else if ((LA11_0 == BooleanLiteral || LA11_0 == CharacterLiteral //
					|| LA11_0 == DecimalLiteral || LA11_0 == FloatingPointLiteral//
					|| (LA11_0 >= HexLiteral && LA11_0 <= Identifier) //
					|| LA11_0 == Not || LA11_0 == OctalLiteral || LA11_0 == StringLiteral || LA11_0 == 35)) alt11 = 2;
			else {
				if (state.backtracking > 0) {
					state.failed = true;
					return retval;
			...
			case 1:
				...
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					Additive32_tree = (CommonTree) adaptor.create(Additive32);
	...
	public final FelParser.unaryExpressionNotPlusMinus_return unaryExpressionNotPlusMinus() throws RecognitionException {
		...
		try {
			...
			if ((LA13_0 == Not)) alt13 = 1;
			else if ((LA13_0 == BooleanLiteral || LA13_0 == CharacterLiteral //
					|| LA13_0 == DecimalLiteral || LA13_0 == FloatingPointLiteral//
					|| (LA13_0 >= HexLiteral && LA13_0 <= Identifier) //
					|| LA13_0 == OctalLiteral || LA13_0 == StringLiteral || LA13_0 == 35)) alt13 = 2;
			else {
				if (state.backtracking > 0) {
					state.failed = true;
					return retval;
		...
		try {
			...
			loop14: do {
				...
				case 1:
					...
					if (state.failed) return retval;
					if (state.backtracking == 0) {
						Bracket41_tree = (CommonTree) adaptor.create(Bracket41);
	...
	public final FelParser.primary_return primary() throws RecognitionException {
		...
		try {
			...
			case StringLiteral:
				...
				if ((synpred17_Fel())) alt16 = 2;
				else if ((true)) alt16 = 3;
				else {
					if (state.backtracking > 0) {
						state.failed = true;
						return retval;
			...
			case 2:
				...
				loop15: do {
					...
					case 1:
						...
						if (state.failed) return retval;
						if (state.backtracking == 0) {
							Dot46_tree = (CommonTree) adaptor.create(Dot46);
	...
	public final FelParser.parDot_return parDot() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					StringLiteral50_tree = (CommonTree) adaptor.create(StringLiteral50);
			...
			case 3:
				...
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					CharacterLiteral51_tree = (CommonTree) adaptor.create(CharacterLiteral51);
	...
	public final FelParser.identifierOrFun_return identifierOrFun() throws RecognitionException {
		...
		try {
			...
			if ((LA18_0 == Identifier)) {
				...
				if ((LA18_1 == EOF || (LA18_1 >= Additive && LA18_1 <= And) || LA18_1 == Bracket || LA18_1 == Colon || (LA18_1 >= Dot
						&& LA18_1 <= Equals) || LA18_1 == Multiplicative || (LA18_1 >= Or && LA18_1 <= Relational) || (LA18_1 >= 36
								&& LA18_1 <= 38))) alt18 = 1;
				else if ((LA18_1 == 35)) alt18 = 2;
				else {
					if (state.backtracking > 0) {
						state.failed = true;
						return retval;
			...
			case 1:
				...
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					Identifier52_tree = (CommonTree) adaptor.create(Identifier52);
			...
			case 2:
				...
				if (state.backtracking == 0) if ((arguments54 != null ? input.toString(arguments54.start, arguments54.stop) : null) != null)
	...
	public final FelParser.arguments_return arguments() throws RecognitionException {
		...
		try {
			...
			if ((LA19_0 == Additive || LA19_0 == BooleanLiteral || LA19_0 == CharacterLiteral || LA19_0 == DecimalLiteral
					|| LA19_0 == FloatingPointLiteral || (LA19_0 >= HexLiteral && LA19_0 <= Identifier) || LA19_0 == Not
					|| LA19_0 == OctalLiteral || LA19_0 == StringLiteral || LA19_0 == 35 || LA19_0 == 37)) alt19 = 1;
			else if ((LA19_0 == 36)) {
				int LA19_2 = input.LA(2);
				if ((synpred21_Fel())) alt19 = 1;
			}
			switch (alt19) {
			case 1:
				// E:\\workspace\\Fel\\Fel.g:127:14: expressionList
	...
	public final FelParser.literal_return literal() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				root_0 = (CommonTree) adaptor.nil();
				FloatingPointLiteral59 = (Token) match(input, FloatingPointLiteral, FOLLOW_FloatingPointLiteral_in_literal679);
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					FloatingPointLiteral59_tree = (CommonTree) adaptor.create(FloatingPointLiteral59);
			...
			case 3:
				...
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					CharacterLiteral60_tree = (CommonTree) adaptor.create(CharacterLiteral60);
			...
			case 5:
				...
				if (state.failed) return retval;
				if (state.backtracking == 0) {
					BooleanLiteral62_tree = (CommonTree) adaptor.create(BooleanLiteral62);
	...
	public static final BitSet FOLLOW_expressionList_in_parExpression108 = new BitSet(new long[] { 0x0000001000000000L });
	public static final BitSet FOLLOW_36_in_parExpression110 = new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_conditionalExpression_in_expressionList130 = new BitSet(new long[] { 0x0000002000000002L });
	public static final BitSet FOLLOW_37_in_expressionList137 = new BitSet(new long[] { 0x00000029141A0A52L });
	public static final BitSet FOLLOW_conditionalExpression_in_expressionList140 = new BitSet(new long[] { 0x0000002000000002L });
	public static final BitSet FOLLOW_conditionalOrExpression_in_conditionalExpression171 = new BitSet(new long[] { 0x0000000040000002L });
	public static final BitSet FOLLOW_Ques_in_conditionalExpression175 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_conditionalExpression_in_conditionalExpression178 = new BitSet(new long[] { 0x0000000000000400L });
	public static final BitSet FOLLOW_Colon_in_conditionalExpression180 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_conditionalExpression_in_conditionalExpression183 = new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_conditionalAndExpression_in_conditionalOrExpression199 = new BitSet(new long[] {
			0x0000000020000002L });
	public static final BitSet FOLLOW_Or_in_conditionalOrExpression202 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_conditionalAndExpression_in_conditionalOrExpression205 = new BitSet(new long[] {
			0x0000000020000002L });
	public static final BitSet FOLLOW_equalityExpression_in_conditionalAndExpression219 = new BitSet(new long[] { 0x0000000000000022L });
	public static final BitSet FOLLOW_And_in_conditionalAndExpression222 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_equalityExpression_in_conditionalAndExpression225 = new BitSet(new long[] { 0x0000000000000022L });
	public static final BitSet FOLLOW_relationalExpression_in_equalityExpression243 = new BitSet(new long[] { 0x0000000000002002L });
	public static final BitSet FOLLOW_Equals_in_equalityExpression247 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_relationalExpression_in_equalityExpression250 = new BitSet(new long[] { 0x0000000000002002L });
	public static final BitSet FOLLOW_additiveExpression_in_relationalExpression272 = new BitSet(new long[] { 0x0000000080000002L });
	public static final BitSet FOLLOW_Relational_in_relationalExpression276 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_additiveExpression_in_relationalExpression279 = new BitSet(new long[] { 0x0000000080000002L });
	public static final BitSet FOLLOW_multiplicativeExpression_in_additiveExpression301 = new BitSet(new long[] { 0x0000000000000012L });
	public static final BitSet FOLLOW_Additive_in_additiveExpression304 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_multiplicativeExpression_in_additiveExpression307 = new BitSet(new long[] { 0x0000000000000012L });
	public static final BitSet FOLLOW_unaryExpression_in_multiplicativeExpression329 = new BitSet(new long[] { 0x0000000002000002L });
	public static final BitSet FOLLOW_Multiplicative_in_multiplicativeExpression333 = new BitSet(new long[] { 0x00000009141A0A50L });
	public static final BitSet FOLLOW_unaryExpression_in_multiplicativeExpression336 = new BitSet(new long[] { 0x0000000002000002L });
	...
	public static final BitSet FOLLOW_unaryExpressionNotPlusMinus_in_unaryExpression365 = new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_Not_in_unaryExpressionNotPlusMinus380 = new BitSet(new long[] { 0x00000009141A0A40L });
	public static final BitSet FOLLOW_unaryExpressionNotPlusMinus_in_unaryExpressionNotPlusMinus383 = new BitSet(new long[] {
			0x0000000000000002L });
	public static final BitSet FOLLOW_array_in_unaryExpressionNotPlusMinus397 = new BitSet(new long[] { 0x0000000000001002L });
	public static final BitSet FOLLOW_Dot_in_unaryExpressionNotPlusMinus400 = new BitSet(new long[] { 0x0000000100100200L });
	public static final BitSet FOLLOW_parDot_in_unaryExpressionNotPlusMinus403 = new BitSet(new long[] { 0x0000000000001002L });
	...
	public static final BitSet FOLLOW_FloatingPointLiteral_in_literal679 = new BitSet(new long[] { 0x0000000000000002L });
	...
	public static final BitSet FOLLOW_expressionList_in_synpred21_Fel627 = new BitSet(new long[] { 0x0000000000000002L });
}