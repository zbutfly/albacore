...
public class FelLexer extends Lexer {
	...
	public final void mMultiplicative() throws RecognitionException {
		try {
			...
			// D:\\129\\ws\\fel\\Fel.g:
			if (input.LA(1) == '%' || input.LA(1) == '*' || input.LA(1) == '/') input.consume();
			else {
	...
	public final void mHexLiteral() throws RecognitionException {
		try {
			...
			match('0');
			if (input.LA(1) == 'X' || input.LA(1) == 'x') input.consume();
			else {
				MismatchedSetException mse = new MismatchedSetException(null, input);
				recover(mse);
				throw mse;
			...
			loop3: do {
				...
				if (((LA3_0 >= '0' && LA3_0 <= '9') || (LA3_0 >= 'A' && LA3_0 <= 'F') || (LA3_0 >= 'a' && LA3_0 <= 'f'))) alt3 = 1;

				switch (alt3) {
				case 1:
					// D:\\129\\ws\\fel\\Fel.g:
					if ((input.LA(1) >= '0' && input.LA(1) <= '9') || (input.LA(1) >= 'A' && input.LA(1) <= 'F') || (input.LA(1) >= 'a'
							&& input.LA(1) <= 'f')) input.consume();
					else {
						MismatchedSetException mse = new MismatchedSetException(null, input);
						recover(mse);
						throw mse;
			...
			if ((LA4_0 == 'L' || LA4_0 == 'l')) alt4 = 1;
			switch (alt4) {
			case 1:
				// D:\\129\\ws\\fel\\Fel.g:
				if (input.LA(1) == 'L' || input.LA(1) == 'l') input.consume();
				else {
					MismatchedSetException mse = new MismatchedSetException(null, input);
					recover(mse);
					throw mse;
	...
	public final void mDecimalLiteral() throws RecognitionException {
		try {
			...
			if ((LA6_0 == '0')) alt6 = 1;
			else if (((LA6_0 >= '1' && LA6_0 <= '9'))) alt6 = 2;
			else {
	...
	public final void mHexDigit() throws RecognitionException {
		try {
			...
			if ((input.LA(1) >= '0' && input.LA(1) <= '9')//
					...
					|| (input.LA(1) >= 'a' && input.LA(1) <= 'f')) input.consume();
			else {
				MismatchedSetException mse = new MismatchedSetException(null, input);
				recover(mse);
				throw mse;
	...
	public final void mFloatingPointLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// D:\\129\\ws\\fel\\Fel.g:203:2: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+
			// ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ FloatTypeSuffix )
			int alt21 = 4;
			...
			case 1:
				...
				if ((LA14_0 == 'D' || LA14_0 == 'F' || LA14_0 == 'd' || LA14_0 == 'f')) alt14 = 1;
				switch (alt14) {
				case 1:
					// D:\\129\\ws\\fel\\Fel.g:
					if (input.LA(1) == 'D' || input.LA(1) == 'F' || input.LA(1) == 'd' || input.LA(1) == 'f') input.consume();
					else {
						MismatchedSetException mse = new MismatchedSetException(null, input);
						recover(mse);
						throw mse;
			...
			case 2:
				...
				if ((LA17_0 == 'D' || LA17_0 == 'F' || LA17_0 == 'd' || LA17_0 == 'f')) alt17 = 1;
			...
			case 3:
				...
				if ((LA19_0 == 'D' || LA19_0 == 'F' || LA19_0 == 'd' || LA19_0 == 'f')) alt19 = 1;
				switch (alt19) {
				case 1:
					// D:\\129\\ws\\fel\\Fel.g:
					if (input.LA(1) == 'D' || input.LA(1) == 'F' || input.LA(1) == 'd' || input.LA(1) == 'f') input.consume();
		...
		try {
			...
			// D:\\129\\ws\\fel\\Fel.g:220:8: '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"'
			{
				...
				loop25: do {
					...
					if ((LA25_0 == '\\')) alt25 = 1;
					else if (((LA25_0 >= '\u0000' && LA25_0 <= '!') || (LA25_0 >= '#' && LA25_0 <= '[') || (LA25_0 >= ']'
							&& LA25_0 <= '\uFFFF'))) alt25 = 2;
					switch (alt25) {
					case 1:
					...
					case 2:
						...
						if ((input.LA(1) >= '\u0000' && input.LA(1) <= '!') //
								...
								|| (input.LA(1) >= ']' && input.LA(1) <= '\uFFFF')) input.consume();
						else {
							MismatchedSetException mse = new MismatchedSetException(null, input);
							recover(mse);
							throw mse;
	...
	public final void mEscapeSequence() throws RecognitionException {
		try {
			// D:\\129\\ws\\fel\\Fel.g:227:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape |
			// OctalEscape )
			int alt26 = 3;
			...
			case 1:
				...
				match('\\');
				if (input.LA(1) == '\"' || input.LA(1) == '\'' || input.LA(1) == '\\' || input.LA(1) == 'b' || input.LA(1) == 'f' || input
						.LA(1) == 'n' || input.LA(1) == 'r' || input.LA(1) == 't') input.consume();
				else {
					MismatchedSetException mse = new MismatchedSetException(null, input);
					recover(mse);
					throw mse;
	...
	public final void mOctalEscape() throws RecognitionException {
		try {
			// D:\\129\\ws\\fel\\Fel.g:234:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) |
			// '\\\\' ( '0' .. '7' ) )
			int alt27 = 3;
			...
			if ((LA27_0 == '\\')) {
				...
				if (((LA27_1 >= '0' && LA27_1 <= '3'))) {
					...
					if (((LA27_2 >= '0' && LA27_2 <= '7'))) {
						...
						if (((LA27_4 >= '0' && LA27_4 <= '7'))) alt27 = 1;
						else alt27 = 2;
					} else alt27 = 3;
				} else if (((LA27_1 >= '4' && LA27_1 <= '7'))) {
					int LA27_3 = input.LA(3);

					if (((LA27_3 >= '0' && LA27_3 <= '7'))) alt27 = 2;
					else alt27 = 3;
				} else {
			...
			case 1:
				...
				match('\\');
				if ((input.LA(1) >= '0' && input.LA(1) <= '3')) input.consume();
				else {
					MismatchedSetException mse = new MismatchedSetException(null, input);
					recover(mse);
					throw mse;
	...
	public final void mIdentifier() throws RecognitionException {
		try {
			...
			loop28: do {
				...
				if (LA28_0 == '$' || (LA28_0 >= '0' && LA28_0 <= '9') || (LA28_0 >= 'A' && LA28_0 <= 'Z')//
						|| LA28_0 == '_' || (LA28_0 >= 'a' && LA28_0 <= 'z') || (LA28_0 >= '\u00C0' && LA28_0 <= '\u00D6')//
						|| (LA28_0 >= '\u00D8' && LA28_0 <= '\u00F6') || (LA28_0 >= '\u00F8' && LA28_0 <= '\u1FFF')//
						|| (LA28_0 >= '\u3040' && LA28_0 <= '\u318F') || (LA28_0 >= '\u3300' && LA28_0 <= '\u337F')//
						|| (LA28_0 >= '\u3400' && LA28_0 <= '\u3D2D') || (LA28_0 >= '\u4E00' && LA28_0 <= '\u9FFF')//
						|| (LA28_0 >= '\uF900' && LA28_0 <= '\uFAFF')) alt28 = 1;
				...
				case 1:
					...
					if (input.LA(1) == '$' || (input.LA(1) >= '0' && input.LA(1) <= '9') || (input.LA(1) >= 'A' && input.LA(1) <= 'Z')
							...
							|| (input.LA(1) >= '\uF900' && input.LA(1) <= '\uFAFF')) input.consume();
					else {
						MismatchedSetException mse = new MismatchedSetException(null, input);
						recover(mse);
						throw mse;
	...
	public final void mLetter() throws RecognitionException {
		try {
			// D:\\129\\ws\\fel\\Fel.g:252:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' ..
			// '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' ..
			// '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
			// D:\\129\\ws\\fel\\Fel.g:
	...
	public final void mJavaIDDigit() throws RecognitionException {
		try {
			// D:\\129\\ws\\fel\\Fel.g:269:5: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' ..
			// '\\u096f' | '\\u09e6' .. '\\u09ef' | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' | '\\u0be7' ..
			// '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66' .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' ..
			// '\\u0ed9' | '\\u1040' .. '\\u1049' )
			// D:\\129\\ws\\fel\\Fel.g:
			if ((input.LA(1) >= '0' && input.LA(1) <= '9') || (input.LA(1) >= '\u0660' && input.LA(1) <= '\u0669')//
					...
					|| (input.LA(1) >= '\u1040' && input.LA(1) <= '\u1049')) input.consume();
			else {
				MismatchedSetException mse = new MismatchedSetException(null, input);
				recover(mse);
				throw mse;
		...
		try {
			...
			loop29: do {
				...
				if ((LA29_0 == '*')) {
					...
					if ((LA29_1 == '/')) alt29 = 2;
					else if (((LA29_1 >= '\u0000' && LA29_1 <= '.') || (LA29_1 >= '0' && LA29_1 <= '\uFFFF'))) alt29 = 1;
				} else if (((LA29_0 >= '\u0000' && LA29_0 <= ')') || (LA29_0 >= '+' && LA29_0 <= '\uFFFF'))) alt29 = 1;
	...
	public final void mLINE_COMMENT() throws RecognitionException {
		try {
			...
			loop30: do {
				...
				if (((LA30_0 >= '\u0000' && LA30_0 <= '\t') || (LA30_0 >= '\u000B' && LA30_0 <= '\f') || (LA30_0 >= '\u000E'
						&& LA30_0 <= '\uFFFF'))) alt30 = 1;
				switch (alt30) {
				case 1:
					// D:\\129\\ws\\fel\\Fel.g:
	...
	public void mTokens() throws RecognitionException {
		// D:\\129\\ws\\fel\\Fel.g:1:8: ( T__35 | T__36 | T__37 | T__38 | Dot | Or | And | Not | Ques | Bracket | Colon | Relational |
		// Equals | Multiplicative | Additive | HexLiteral | DecimalLiteral | OctalLiteral | BooleanLiteral | FloatingPointLiteral |
	...
	static final String DFA21_eofS = "\6\uffff";
	static final String DFA21_minS = "\2\56\4\uffff";
	static final String DFA21_maxS = "\1\71\1\146\4\uffff";
	static final String DFA21_acceptS = "\2\uffff\1\2\1\1\1\3\1\4";
	static final String DFA21_specialS = "\6\uffff}>";
	static final String[] DFA21_transitionS = { "\1\2\1\uffff\12\1", "\1\3\1\uffff\12\1\12\uffff\1\5\1\4\1\5\35\uffff\1\5\1\4\1\5", "", "",
			"", "" };
	...
	static final String DFA32_eotS = "\5\uffff\1\31\2\uffff\1\33\5\uffff\1\30\1\uffff\2\37\2\26\14\uffff"
			+ "\1\44\1\37\2\26\1\uffff\2\26\1\51\1\26\1\uffff\1\51";
	static final String DFA32_eofS = "\53\uffff";
	static final String DFA32_minS = "\1\11\4\uffff\1\60\2\uffff\1\75\5\uffff\1\52\1\uffff\2\56\1\162"
			+ "\1\141\14\uffff\2\56\1\165\1\154\1\uffff\1\145\1\163\1\44\1\145" + "\1\uffff\1\44";
	static final String DFA32_maxS = "\1\ufaff\4\uffff\1\71\2\uffff\1\75\5\uffff\1\57\1\uffff\1\170\1"
			+ "\146\1\162\1\141\14\uffff\2\146\1\165\1\154\1\uffff\1\145\1\163" + "\1\ufaff\1\145\1\uffff\1\ufaff";
	static final String DFA32_acceptS = "\1\uffff\1\1\1\2\1\3\1\4\1\uffff\1\6\1\7\1\uffff\1\11\1\12\1\13"
			+ "\1\14\1\15\1\uffff\1\17\4\uffff\1\25\1\26\1\27\1\30\1\16\1\5\1\24"
			+ "\1\10\1\31\1\32\1\20\1\21\4\uffff\1\22\4\uffff\1\23\1\uffff";
	static final String DFA32_specialS = "\53\uffff}>";
	static final String[] DFA32_transitionS = { "\2\27\1\uffff\2\27\22\uffff\1\27\1\10\1\25\1\uffff\1\26\1\30"
			+ "\1\7\1\24\1\1\1\2\1\30\1\17\1\3\1\17\1\5\1\16\1\20\11\21\1\13"
			+ "\1\uffff\1\14\1\15\1\14\1\11\1\uffff\32\26\1\12\1\uffff\1\4" + "\1\uffff\1\26\1\uffff\5\26\1\23\15\26\1\22\6\26\1\uffff\1\6"
			+ "\103\uffff\27\26\1\uffff\37\26\1\uffff\u1f08\26\u1040\uffff"
			+ "\u0150\26\u0170\uffff\u0080\26\u0080\uffff\u092e\26\u10d2\uffff" + "\u5200\26\u5900\uffff\u0200\26", "", "", "", "",
			"\12\32", "", "", "\1\15", "", "", "", "", "", "\1\34\4\uffff\1\35", "",
			"\1\32\1\uffff\10\40\2\32\12\uffff\3\32\21\uffff\1\36\13\uffff" + "\3\32\21\uffff\1\36",
			"\1\32\1\uffff\12\41\12\uffff\3\32\35\uffff\3\32", "\1\42", "\1\43", "", "", "", "", "", "", "", "", "", "", "", "",
			"\1\32\1\uffff\10\40\2\32\12\uffff\3\32\35\uffff\3\32", "\1\32\1\uffff\12\41\12\uffff\3\32\35\uffff\3\32", "\1\45", "\1\46", "",
			"\1\47", "\1\50", "\1\26\13\uffff\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\32"
					+ "\26\105\uffff\27\26\1\uffff\37\26\1\uffff\u1f08\26\u1040\uffff"
					+ "\u0150\26\u0170\uffff\u0080\26\u0080\uffff\u092e\26\u10d2\uffff" + "\u5200\26\u5900\uffff\u0200\26", "\1\52", "",
			"\1\26\13\uffff\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\32" + "\26\105\uffff\27\26\1\uffff\37\26\1\uffff\u1f08\26\u1040\uffff"
					+ "\u0150\26\u0170\uffff\u0080\26\u0080\uffff\u092e\26\u10d2\uffff" + "\u5200\26\u5900\uffff\u0200\26" };
