...
//		this.username = null;
//		this.gson = new Gson();
//		this.client = new AsyncHttpClient(new NettyAsyncHttpProvider(new AsyncHttpClientConfig.Builder().build()));
//	}
//
...
//		Response resp;
//		try {
//			resp = this.client.prepareGet(this.authUrl).addHeader(STORAGE_USER_HEADER_NAME, this.username)
...
//		Response resp;
//		try {
//			resp = this.client.prepareHead(this.serviceUrl + "/" + container).execute().get();
//		} catch (InterruptedException e) {
//			throw new OperationFailureException(e);
//		} catch (ExecutionException e) {
//			throw new OperationFailureException(e.getCause());
...
//		Response resp;
//		try {
//			resp = this.client.preparePut(this.serviceUrl + "/" + container).execute().get();
//		} catch (InterruptedException e) {
//			throw new OperationFailureException(e);
//		} catch (ExecutionException e) {
//			throw new OperationFailureException(e.getCause());
...
//		Response resp;
//		try {
//			resp = this.client.prepareDelete(this.serviceUrl + "/" + container).execute().get();
//		} catch (InterruptedException e) {
//			throw new OperationFailureException(e);
//		} catch (ExecutionException e) {
//			throw new OperationFailureException(e.getCause());
...
//		Response resp;
//		try {
//			resp = this.client.prepareHead(this.serviceUrl + "/" + container + "/" + object).execute().get();
//		} catch (InterruptedException e) {
//			throw new OperationFailureException(e);
//		} catch (ExecutionException e) {
//			throw new OperationFailureException(e.getCause());
...
//				if (r.containsKey(n)) throw new OperationFailureException("Conflict object metadata key: " + n);
...
//			UnknownResponseException, AuthenticationFailureException {
//		BoundRequestBuilder req = this.client.preparePost(this.serviceUrl + "/" + container + "/" + object);
...
//			UnknownResponseException, AuthenticationFailureException {
//		BoundRequestBuilder req = this.client.prepareGet(this.serviceUrl + "/" + container + "/" + object);
...
//	}
//
//	private BoundRequestBuilder initcp(String container, String object, Map<String, String> metadata) {
//		BoundRequestBuilder req = this.client.preparePut(this.serviceUrl + "/" + container + "/" + object);
//		if (null != metadata) {
...
//	 * @throws AuthenticationFailureException
//	 */
//	private int handleStatusCode(Response response, int... ignoreCodes) throws UnknownResponseException,
//			OperationFailureException {
//		ResponseStatus r = new ResponseStatus(response.getStatusCode(), response.getStatusText());
...
//				r.add(new BasicHeader(IF_MODIFIED_SINCE_HEADER_NAME, DateUtils.httpFormat.format(this.modifiedSince)));
//			if (this.unmodifiedSince != null)
//				r.add(new BasicHeader(IF_UNMODIFIED_SINCE_HEADER_NAME, DateUtils.httpFormat.format(this.unmodifiedSince)));
