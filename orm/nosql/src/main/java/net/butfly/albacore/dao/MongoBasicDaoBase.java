...
public abstract class MongoBasicDaoBase<E extends MongoEntity> extends MongoDaoBase<E> implements MongoDao<E> {
	...
	// private <E extends AbstractEntity> BasicDAO<E, ObjectId>
	// createDAO(Class<E> clazz) {
	// return new BasicDAO<E, ObjectId>(clazz, this.store);
	// }
	//
	// public <E extends AbstractEntity> long count(Class<E> entityClass,
	// Query<E> criteria) {
	...
	// }
	//
	// public <E extends AbstractEntity> E delete(Class<E> entityClass, ObjectId
	// key) {
	...
	// }
	//
	// public <E extends AbstractEntity> int delete(Class<E> entityClass,
	// ObjectId[] keys) {
	// // TODO Auto-generated method stub
	// return 0;
	// }
	//
	// public <E extends AbstractEntity> int delete(Class<E> entityClass, Query
	// Query) {
	...
	// UpdateOperations<E> opts = (UpdateOperations<E>)
	// this.store.createUpdateOperations(entity.getClass());
	...
	// }
	//
	// public <E extends AbstractEntity> E select(Class<E> entityClass, ObjectId
	// key) {
	// return this.store.get(entityClass, key);
	// }
	//
	// @SuppressWarnings("unchecked")
	// public <E extends AbstractEntity> E[] select(Class<E> entityClass,
	// ObjectId[] key) {
	// List<E> l = this.store.get(entityClass, Arrays.asList(key)).asList();
	// return l.toArray((E[]) Array.newInstance(entityClass, l.size()));
	// }
	//
	// public <E extends AbstractEntity> E[] select(Class<E> entityClass, Query
	// criteria, Page page) {
	// // TODO Auto-generated method stub
	// return null;
	// }
	//
	// @SuppressWarnings("unchecked")
	// protected <E extends AbstractEntity> BasicDAO<E, ObjectId>
