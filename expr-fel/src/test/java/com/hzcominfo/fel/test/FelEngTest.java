...
public class FelEngTest {
	public static void main(String[] args) {
		String caseResult = Engine.eval("case(type, '001', phone, '002', qq, null)", //
				Maps.of("type", "001", //
						"phone", "057188338822", //
						"qq", "2933094"));
		...
		boolean actully = Engine.eval("match('001', reg)", Maps.of("reg", regex));
	...
	public static void testParalsEval() {
		...
		for (int i = 0; i < 1000; i++)
			fs.add(() -> Engine.eval("match('001', reg)", Maps.of("reg", "\\d*")));
