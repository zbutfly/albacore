...
import static net.butfly.albacore.steam.IteratorSteam.SafeIterator.of;
...
public class IteratorSteam<E> extends SteamBase<E, Iterator<E>, IteratorSteam<E>> implements Steam<E> {
	public IteratorSteam(Iterator<E> impl) {
		super(of(impl));
	}
	...
	public <R> Steam<R> map(Function<E, R> conv) {
		return Steam.wrap(new Iterator<R>() {
			@Override
